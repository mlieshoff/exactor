...
// -------------------------- OTHER METHODS --------------------------
    ...
    public void execute() throws Exception
    {
        try
        {
            getStepRunner().run( createStep( getAbbotScript(),
    ...
    protected Step createStep( Script script, String str )
    ...
    protected String buildAbbotXml( String abbotXML )
            throws Exception
    {
        return createAbbotXML( abbotXML,
    ...
    protected String createAbbotXML( String abbotXML, ReplacementDefinition[] replacementDefinitions ) throws Exception
    {
        ...
        for ( int i = 0; i < replacementDefinitions.length; i++ )
        {
            ...
            String paramValue = getParameter( replacementDefinition.exactorParameterPosition,
                    replacementDefinition.defaultParameterValue ).stringValue();
