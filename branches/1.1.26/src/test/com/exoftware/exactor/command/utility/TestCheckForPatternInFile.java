...
import com.exoftware.exactor.command.utility.CheckForPatternInFile;
...
public class TestCheckForPatternInFile extends TestCase
{
   ...
   public static final String FULL_PATH_TO_PATTERN_FILE = Constants.pathToTestFile( "checkforpatterninfile" + PATTERN_FILE );
   ...
   {
      CheckForPatternInFile checkForPatternInFile = new CheckForPatternInFile();
      checkForPatternInFile.setScript( new Script( new File(Constants.pathToTestFile( "checkforpatterninfile/script_for_relative_path_test.act" )) ));
