...
public class AbbotComponent extends AbstractAbbotCommand
{
   ...
   public void execute() throws Exception
   {
      try
      {
         getAbbotScript().addComponentReference(new ComponentReference(getAbbotScript(),
                                                                       Util.createElement(buildAbbotXml(getTemplateXML()))));

         getScript().getContext().put(SWING_CONTAINER_KEYS, AWTHierarchy.getDefault().getRoots().toArray(new  Container[]{}));
      }
