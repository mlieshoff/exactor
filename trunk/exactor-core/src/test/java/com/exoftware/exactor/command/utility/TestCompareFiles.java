...
public class TestCompareFiles extends TestCase {
    ...
    public void testCompareFiles_DoNotMatch() throws Exception {
        ...
        try {
            ...
            assertEquals("Content of expected file: '" + Constants.pathToTestFile("comparefiles/expected_file.txt")
                    + "' does not match actual file: '" +
    ...
    public void testCompareFilesRelative_Match() throws Exception {
        ...
        compareFiles.setScript(new Script(new File(Constants.pathToTestFile(
                "comparefiles/script_for_relative_path_test.act"))));
